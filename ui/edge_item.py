...
"""
========================================================================
ЭЛЕМЕНТ СВЯЗИ ДЛЯ ГРАФИЧЕСКОЙ СЦЕНЫ
========================================================================
ЧАСТЬ ПРОЕКТА: Карта жизни (Альфа-версия 1.0)
АВТОР: vilfum
ЛИЦЕНЗИЯ: См. файл LICENSE
КОНФИДЕНЦИАЛЬНО: Внешний вид и поведение связи являются
...
class EdgeItem(QGraphicsObject):
    ...
    def boundingRect(self):
        ...
        padding = 3  # Добавляем отступ для стрелки и выделения
    ...
    def paint(self, painter, option, widget=None):
        ...
        # Сначала рисуем прозрачный boundingRect
